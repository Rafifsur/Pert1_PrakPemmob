...
import com.example.pertemuan1.databinding.ActivityHalaman2Binding
...
class Halaman2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            // Log and show a toast so we can see why the activity failed to start
            Log.e("Halaman2Activity", "Error during onCreate", e)
            Toast.makeText(this, "Gagal membuka Halaman 2: ${e.message}", Toast.LENGTH_LONG).show()
            // Avoid leaving the activity in a bad state; finish after notifying user
            finish()
        }
    }
